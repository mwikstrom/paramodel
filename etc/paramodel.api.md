...
// @public (undocumented)
export type StateApplyFunc<C extends Change = Change, R extends ReadModel = ReadModel, T = unknown> = (this: void, change: C, before: T, view: ViewSnapshotFunc<R>) => Promise<T>;
